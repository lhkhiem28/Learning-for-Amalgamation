...
class PhoBert(nn.Module):
    def __init__(self, config_phobert, hidden_size=128, dropout_prob=0.1, maxlen=128):
        ...
        self.num_labels = self.config_phobert.num_labels
        self.phobert = RobertaModel(config_phobert)

        self.dropout = nn.Dropout(self.dropout_prob)
        self.classifier = nn.Linear(config_phobert.hidden_size, config_phobert.num_labels)
